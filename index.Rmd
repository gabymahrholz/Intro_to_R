...
These may take the form of coding assessments or multiple choice questions (MCQs) that will be delivered in the same format of the summative assessments- a downloadable file that you fill in the blanks of. 

The answers for each of the formative assessments will be available for you to check your answers.
...
```{block, type = "danger"}
Summative assessments will be due ONE HOUR before the start of the next class the following week.
...
Once you have provided code in all of the appropriate slots you will then upload this file to the appropriate assignment submission page on Moodle.
...
MCQ questions will be included on some of the assessment files that you download, both summative and formative. 

These questions will require you to select an answer for each of the questions by typing the appropriate number of the answer into the indicated spot in the document you are given.

You may need to create some code in order to generate the answers to the MCQ questions on some occassions.
